  ...
  return (
    ...
    <div className={styles.PolicyContentSection}>
        ...
        <div className={styles.para}>
            <p>1. Monthly Fee: Students must pay the monthly fee on or before the specified due date. This ensures uninterrupted access to our resources, services, and facilities. Failure to pay on time may result in restricted access until payment is received.<br/><br/>
...
4. Difficulties: Students facing challenges meeting deadlines are encouraged to contact the finance department promptly. We are here to assist you and work together to find solutions. Your concerns and situations will be handled with confidentiality and understanding.<br/><br/></p>
</div>
...
<div className={styles.para}>
<p>1. Commitment: ALO is committed to providing students with professional growth opportunities. We strive to connect our students with valuable placement opportunities to enhance their careers.<br/>
...
6. Prioritizing Attendance: Regular attendance contributes to academic success and enhances career opportunities. We urge students to prioritize attendance as it directly impacts their educational experience and future career prospects.</p>
</div>
<div className={styles.heading}>
  <h2>Grade Requirement Policy</h2>
  </div>
<div className={styles.para}>
  <p>1. Grade Range: ALO follows a placement grade range from A to C. This range reflects our commitment to excellence and ensures that students are adequately prepared for professional opportunities.<br/><br/>
...
6. Ineligibility: Students failing to meet the A grade criteria are not eligible for placement services. This policy ensures that our placement services are offered to students who have demonstrated a commitment to academic excellence.</p>
        </div>
        <div className={styles.heading}>
